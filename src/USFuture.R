...
#Step 1------------------------------------------
FutToBePrepared<-GetFutInfo(tws, FUT=c("NQ"),interval=c("5FContinuous","30FContinuous","1HContinuous","Continuous","WContinuous"), RealData=TRUE)
...
StockChart(NQContinuous, Title = "NQContinuous")
