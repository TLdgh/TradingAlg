...
data_old=read.csv("Data/OriginalStockData/US/SectorDistribution/distribution_20241121.csv")
data_new=read.csv("Data/OriginalStockData/US/SectorDistribution/distribution_20241122.csv")
