...
data_old=read.csv("Data/OriginalStockData/US/SectorDistribution/distribution_20241023.csv")
data_new=read.csv("Data/OriginalStockData/US/SectorDistribution/distribution_20241024.csv")
