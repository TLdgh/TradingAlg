...
#weekly:
FUT_NQ1<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20200320.csv"),header=T) 
FUT_NQ2<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20200619.csv"),header=T) 
FUT_NQ3<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20200918.csv"),header=T) 
FUT_NQ4<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20201218.csv"),header=T) 
FUT_NQ5<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20210319.csv"),header=T) 
FUT_NQ6<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20210618.csv"),header=T) 
FUT_NQ7<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20210917.csv"),header=T) 
FUT_NQ8<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20211217.csv"),header=T) 
FUT_NQ9<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20220318.csv"),header=T) 
FUT_NQ10<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20220617.csv"),header=T) 
FUT_NQ11<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQW_20220916.csv"),header=T) 
...
FUT_NQ2<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20191220.csv"),header=T) 
FUT_NQ3<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20200320.csv"),header=T) 
FUT_NQ4<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20200619.csv"),header=T) 
FUT_NQ5<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20200918.csv"),header=T) 
FUT_NQ6<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20201218.csv"),header=T) 
FUT_NQ7<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20210319.csv"),header=T) 
FUT_NQ8<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20210618.csv"),header=T) 
FUT_NQ9<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20210917.csv"),header=T) 
FUT_NQ10<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20211217.csv"),header=T) 
FUT_NQ11<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20220318.csv"),header=T) 
FUT_NQ12<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20220617.csv"),header=T) 
FUT_NQ13<-read.csv(file = paste0(getwd(), "/Data/OriginalFuturesData/NQ/Continuous/NQ_20220916.csv"),header=T) 
